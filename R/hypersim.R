### hypersim.R  (2006-10)
###
### Random hyperboloïd indexed field simulation by the mifieldsim method
###
...
hypersim <- function(R,Ne=100,Nr=100,Ng=100,nbNeighbor=4){

##    INPUT VARIABLES
#########################
##  R   : R function covariance function
##  Ne  : positive integer
...
##      of the hyperboloïd for the third step of the algorithm (Visual refined simulation step).
...
##    OUTPUT VARIABLES
##########################
##  X  : vector of length <= Ne +Nr+Ng^2
##
##  Y  : vector of length <= Ne +Nr+Ng^2
##
##  Z  : vector of length <= Ne +Nr+Ng^2
##
##  W  : vector of length <= Ne +Nr+6Ng^2, W[n] gives the value of the process
##  at point (X[n],Y[n],Z[n]).
##      
##  W1 : matrice of size NgxNg gives values of 
...
return(list(X=X,Y=Y,Z=Z,W=W,W1=W1,time=time[[3]]))
}
